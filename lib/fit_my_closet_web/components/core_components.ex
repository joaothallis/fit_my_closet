defmodule FitMyClosetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FitMyClosetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FitMyClosetWeb.Gettext, "errors", msg, opts)
    end
  end
